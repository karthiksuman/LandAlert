  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h3 style={{ fontSize: '1.15rem', color: 'var(--color-navy)' }}>Assigned Field Operations</h3>
        ...
        {fieldTasks.map(task => {
          ...
          return (
            <div
              ...
              style={{
                cursor: 'pointer',
                borderColor: isSelected ? 'var(--color-blue-500)' : 'var(--color-border)',
                boxShadow: isSelected ? 'var(--shadow-focus)' : 'var(--shadow-sm)'
              }}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                    <span style={{ fontSize: '0.82rem', fontWeight: 800, color: 'var(--color-blue-500)', fontFamily: 'var(--font-mono)' }}>
                      {task.id}
                    </span>
                  ...
                  <h4 style={{ color: 'var(--color-navy)', fontSize: '0.98rem' }}>{task.title}</h4>
                </div>
