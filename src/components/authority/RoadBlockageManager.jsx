  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button className="btn-outline-cyan" onClick={() => setIsFullScreenMap(true)}>
          <Navigation size={15} />
          ...
          return (
            <div key={road.id} className="glass-panel" style={{ padding: '20px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                    <h3 style={{ fontSize: '1.1rem', color: '#fff' }}>{road.name}</h3>
              ...
              {alt && (
                ...
                >
                  <div>
                    <div style={{ fontSize: '0.72rem', fontWeight: 700, color: '#00E676', textTransform: 'uppercase', marginBottom: '2px' }}>
