  ...
  return (
    <div style={{ marginTop: '16px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '20px' }}>
        ...
        <button
          className={phase === 'AFTER' ? 'btn-outline-cyan' : 'btn-secondary'}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px' }}>
          <div className="glass-panel" style={{ padding: '18px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <Eye size={20} color="#29B6F6" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Monitor Geological Alerts</h4>
            </div>
          ...
          <div className="glass-panel" style={{ padding: '18px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              ...
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Prepare 72h Emergency Grab-Bag</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="glass-panel" style={{ padding: '18px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <Compass size={20} color="#FFA726" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Pre-Map Evacuation Routes</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
      ...
      {phase === 'DURING' && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px' }}>
          <div className="glass-panel" style={{ padding: '18px', borderLeft: '4px solid #D32F2F' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <Mountain size={20} color="#FF5252" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Move Lateral to Slide Path</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="glass-panel" style={{ padding: '18px', borderLeft: '4px solid #D32F2F' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <Waves size={20} color="#FF5252" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Avoid Mountain Bridges & Culverts</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="glass-panel" style={{ padding: '18px', borderLeft: '4px solid #D32F2F' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <Home size={20} color="#FF5252" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>If Trapped Indoors: Curl and Protect</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
      ...
      {phase === 'AFTER' && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px' }}>
          <div className="glass-panel" style={{ padding: '18px', borderLeft: '4px solid #29B6F6' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <AlertTriangle size={20} color="#29B6F6" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Watch for Secondary Slides</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="glass-panel" style={{ padding: '18px', borderLeft: '4px solid #29B6F6' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              ...
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Report Injured & Trapped Persons</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="glass-panel" style={{ padding: '18px', borderLeft: '4px solid #29B6F6' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <Shield size={20} color="#29B6F6" />
              <h4 style={{ color: '#fff', fontSize: '0.95rem' }}>Check Foundation Integrity</h4>
            </div>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
