    ...
    <div className="location-info-panel">
      ...
      <div className="location-info-header">
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px' }}>
            ...
            <span style={{ fontSize: '0.7rem', fontWeight: 800, color: 'var(--cyan)', letterSpacing: '0.8px', textTransform: 'uppercase' }}>
      ...
      <div style={{ marginBottom: '14px', background: 'rgba(25, 212, 123, 0.08)', border: '1px solid rgba(25, 212, 123, 0.3)', borderRadius: '8px', padding: '10px 12px' }}>
        ...
        <div style={{ fontSize: '0.8rem', color: '#fff' }}>
          Primary Route (NH-10 Sector B): <span style={{ color: 'var(--risk-critical)', fontWeight: 700 }}>HIGH RISK / BLOCKED</span>
        </div>
